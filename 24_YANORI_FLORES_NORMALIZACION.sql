...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 17:47:08
...
INSERT INTO `tbl_facturas` (`DB_FACTURA`, `DESCRIPCION_FACTURA`, `FECHA`, `ID_DIRECCION`) VALUES
(1, 'Factura de envio', '2021-08-21', 2);
...
--
ALTER TABLE `tbl_facturas`
  MODIFY `DB_FACTURA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
